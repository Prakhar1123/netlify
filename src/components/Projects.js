      ...
      <div className="project-container">
        <div className="project-box">
          <div className="project-images">
            <img src={img} alt="Adidas Shoes" />
            <img src={img1} alt="Puma Shoes 1" />
            <img src={img2} alt="Puma Shoes 2" />
          </div>
          <h3>E-Commerce Project</h3>
          <p>Developed a comprehensive platform for online shoe shopping.</p>
          <a
            href="https://ucxzhgycdg8hi6glxjtrzg.on.drv.tw/Online%20shoe%20shopping/prakhar1.html"
            target="_blank"
        ...
        <div className="project-box_">
          ...
          <p>
            Developed a dynamic Marvel-themed quiz app using React. Integrated useState for question progression and user scoring.
          </p>
          <div className="buttons">
            <a
              href="https://prakhar1123.github.io/avengers"
              target="_blank"
              rel="noopener noreferrer"
              className="demo-button"
            >
            ...
            <a
              href="https://github.com/Prakhar1123/avengers"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="project-box__">
          ...
          <a
            href="https://prakhar1123.github.io/Todolist_new/"
            target="_blank"
            rel="noopener noreferrer"
            className="demo-button"
          >
